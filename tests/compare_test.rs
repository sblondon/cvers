...
mod tests {
    ...
    fn assert_equal(first: &str, second: &str){
        assert_eq!(compare::compare(first, second), Ordering::Equal);
        assert_eq!(compare::compare(second, first), Ordering::Equal);
    }
    #[test]
    ...
    fn assert_not_equal(max: &str, min: &str){
        assert_eq!(compare::compare(max, min), Ordering::Greater);
        assert_eq!(compare::compare(min, max), Ordering::Less);
    }
    #[test]
